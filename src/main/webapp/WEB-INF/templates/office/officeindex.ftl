...
<div style="margin-left:200px;">
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 机构管理 <span class="c-gray en">&gt;</span> 机构列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
	<div class="page-container">
		<#include "/public/datatable.ftl" />
		<@datatable titles=["名称","上级机构","排序","备注","操作"]>
		<div class="text-c"> 机构名称：
			...
			<input type="text" name="name" placeholder=" 机构名称" style="width:250px" class="input-text">
			<button class="btn btn-success" onClick="fnSearch()"><i class="Hui-iconfont">&#xe665;</i> 搜索机构</button>
			<button class="btn btn-primary radius" onClick="oper_add('添加机构','${springMacroRequestContext.contextPath}/office/add')"><i class="Hui-iconfont">&#xe600;</i> 添加机构</button>
		</div>
		</@datatable>
	</div>
</div>
...
<@datatableAjax 
controller="office"
sAjaxSource="${springMacroRequestContext.contextPath}/office/findoffice"
